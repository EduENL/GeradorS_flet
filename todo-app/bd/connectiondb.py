...
class DataBase:
    ...
    def dbExecute(self, query, params=[]):
        ...
        with sqlite3.connect(r'C:\Users\DEV_2ano_2024\Documents\GitHub\GeradorS_flet\todo-app\bd\database.sqlite') as con:
    ...
    def searchItens(self, query):
        ...
        """
        # Substitui a tabela "task" pela tabela "tasks" na consulta SQL
        query = query.replace('"task"', '"tasks"')
